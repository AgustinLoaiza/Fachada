...
#ifdef FACHADA_NaveEnemiga_generated_h
...
template<> FACHADA_API UClass* StaticClass<class ANaveEnemiga>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Fachada_Source_Fachada_NaveEnemiga_h
